...
Do not put initiative-specific planning here. Use initiatives under
`context/initiatives/` for work-specific behavior, testing, delivery,
...
| Reference material | `reference/` | Release-anchored or baseline behavior, if the reference package is used. |
| Decision log | `decisions/` | Durable, append-only architecture and design decisions. |
| Working context | `context/` | Disposable bench: initiatives, plans, per-concern docs, and release-doc notes. |
